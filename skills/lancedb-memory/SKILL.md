#!/usr/bin/env python3
"""
LanceDB integration for OpenClaw long-term memory management.
...
name: lancedb-memory
version: 0.30.2
description: "Vector memory store with custom embedding support. Uses doubao-embedding-vision-251215 via Volcengine Ark API."
